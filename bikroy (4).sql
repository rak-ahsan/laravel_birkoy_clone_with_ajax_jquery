...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 17, 2023 at 02:25 PM
...
--
-- Table structure for table `adslimits`
--

CREATE TABLE `adslimits` (
  `limits_id` bigint(20) UNSIGNED NOT NULL,
  `limit` text NOT NULL,
...
--
-- Dumping data for table `adslimits`
--

INSERT INTO `adslimits` (`limits_id`, `limit`, `created_at`, `updated_at`) VALUES
(1, '10', NULL, '2023-11-17 01:59:25');
...
(14, 5, 7, 'R', '2023-11-15 07:25:45', '2023-11-15 07:25:45');
...
(50, 5, 7, '2023-11-15 07:25:27', '2023-11-15 07:25:27'),
(51, 7, 8, '2023-11-16 09:24:04', '2023-11-16 09:24:04'),
(52, 6, 7, '2023-11-17 07:04:09', '2023-11-17 07:04:09');
...
(1, 'rakib', 6, 'pial', 'hi', '2023-11-16 10:45:08', '2023-11-16 10:45:08');
...
(16, '2023_11_17_072741_create_adslimits_table', 11);
...
(3, 'fake product', 1, 6, '2023-11-12 10:19:45', '2023-11-16 11:55:37');
...
(7, 'Rakib Ahsan', 'cloudysky121@gmail.com', NULL, '$2y$10$EfL4pxLGa6ndSgw9.Z.ZtuXPOajlJdXgwxylKgs9DV2h2LIHURKqO', 'SgEorYBL8p7MhCha8RkyoOq0joOmDmCPqRok5nQt7cutACAn3f7JDMgar2o7', '2023-10-29 23:43:37', '2023-11-11 02:54:02', '01775566772', '1698644617.webp', 1, 'rakib', 1, 1),
...
--
-- Indexes for table `adslimits`
--
ALTER TABLE `adslimits`
...
--
-- AUTO_INCREMENT for table `adslimits`
--
ALTER TABLE `adslimits`
  MODIFY `limits_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `likes`
  MODIFY `like_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
