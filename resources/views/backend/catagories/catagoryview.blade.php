        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> <a class="nav-link edit" data-id="{{$row->cata_id}}" data-bs-toggle="modal" data-bs-target="#exampleModals">Edit</a></td>
                    <td><a class="nav-link" href="{{ route('category.destroy', $row->cata_id) }}">Delete</a></td>
                </tr>
                @endforeach
                @else
                <tr>
