...
<div class="main" style="background-color: #149777;">
    <div class="container " style="height: 200px">
        <div class="row d-flex justify-content-center align-items-center p-5 text-center">
            <div class="top mb-3">
                <span class="text"><i class="fa-solid fa-location-dot mx-2" style="color: #ffffff;"></i> All Over Bangladesh</span>
            </div>
            <div class="search">
                <form class="d-flex  align-items-center" role="search">
                    <input class="form-control me-2 p-3 " type="search" placeholder="What Are You Looking For?" aria-label="Search" style="border-radius: 30px">
                    <i class="fa-solid fa-magnifying-glass fa-2xl p-3" style="color: #000000; margin-left:-80px;border-radius:20px"></i>
                </form>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="part1 col-md-6 d-flex shadow mt-5 p-3">
            ...
            <div class="col-md-8 mt-3">
                ...
                <a href="#" class="btn btn-warning mt-3" style="width: 250px ;border-radius:20px"><i class="fa-solid fa-plus" style="color: #673500;"></i> Post your ad for free</a>
            </div>
        ...
        <div class="part1 col-md-6 d-flex shadow mt-5" style="border-left:1px solid rgb(133, 130, 130)">
            <div class="row p-4">
                ...
                <div class="col-8">
                    <a href="#" class="btn btn-warning  mt-2 " style="width: 250px;background-color:#0074BA; border-radius:20px;color:white"> Explore more <i class="fa-solid fa-arrow-right" style="color: #ffffff;"></i>
                    </a>
                </div>
            </div>
...
<div class="container mb-3 mt-5">
    <div class="row">
        ...
        <div class="col-md-3 p-3" style="background-color:#D3D3D3;">
            ...
            <span>Desktop Computers | Laptops | TVs | Cameras, Camcorders & Accessories | Audio & Sound Systems</span>
        </div>
        <div class="col-md-3 p-3" style="background-color:#D3D3D3">
            <b>63,905 ads in Electronics</b>
            <span>Desktop Computers | Laptops | TVs | Cameras, Camcorders & Accessories | Audio & Sound Systems</span>
...
<div class="container">
    <div class="row">
        ...
        <span class="collapsible" style="margin:10px 0">See More <i class="fa-solid fa-arrow-right" style="color: black;"></i></span>
